...
The 'cliq_dashboard' project was generated by using the default template.

* `src/`: Python source code for this project.
  * `src/cliq_dashboard/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] cliq_dashboard_etl` to your workspace.
